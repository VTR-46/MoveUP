...
describe("Obter Top Treinos", () => {
  // CLASSE DE EQUIVALÊNCIA: Lista com mais treinos que o limite
  ...
  // VALOR LIMITE: Lista com menos treinos que o limite
...
describe("Criar Treino de Modelo", () => {
  // CLASSE DE EQUIVALÊNCIA: Criação com sucesso
...
describe("Filtrar por Grupo Muscular", () => {
  // CLASSE DE EQUIVALÊNCIA: Grupo que encontra resultados
  ...
  // CLASSE DE EQUIVALÊNCIA: Grupo que não encontra resultados
